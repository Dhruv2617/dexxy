...
contract AMMDEX is Ownable {
    ...
    uint256[] public recentPrices; // For volatility checks
    ...
    function addLiquidity(uint256 cBTCAmount, uint256 cUSDAmount) external {
        //require(!isVolatile(), "Market volatile, adding liquidity paused");
    ...
    function removeLiquidity(uint256 lpTokens) external {
        //require(!isVolatile(), "Market volatile, removing liquidity paused");
    ...
    function swapCBTCForCUSD(uint256 cBTCAmtIn, uint256 minCUSDOut) external {
        //require(!isVolatile(), "Market volatile, swaps paused");
        ...
        // Send protocol fee in cBTC to treasury
    ...
    function swapCUSDForCBTC(uint256 cUSDAmtIn, uint256 minCBTCOut) external {
        ...
        // Send protocol fee in cUSD to treasury
